...
class TestKnowledgeMergeContinueSlice(unittest.TestCase):
    ...
    def test_merge_c2_slice(self):
        ...
        ret1 = inference(c2_slice_optimize_onnx, x)
    ...
    def test_merge_c3_slice(self):
        ...
        ret1 = inference(c3_slice_optimize_onnx, x)
        self.assertTrue(np.array_equal(ret, ret1))
    ...
    def test_merge_c4_slice(self):
        ...
        ret1 = inference(c4_slice_optimize_onnx, x)
        self.assertTrue(np.array_equal(ret, ret1))
    ...
    def test_merge_c2_slice_2dims(self):
        ...
        ret = inference(c2_slice_2dims_onnx, x)
        ...
        ret1 = inference(c2_slice_2dims_optimize_onnx, x)
        self.assertTrue(np.array_equal(ret, ret1))
    ...
    def test_merge_c2_slice_2dims_1dims(self):
        ...
        ret = inference(c2_slice_2dims_1dims_onnx, x)
        ...
        ret1 = inference(c2_slice_2dims_1dims_optimize_onnx, x)
        self.assertTrue(np.array_equal(ret, ret1))
