...
@register_op_compute("Vrec", op_mode="dynamic", support_fusion=True)
def vrec_compute(input_x, output_z, kernel_name="vrec"):
...
def exp_neg_dsl(input_x, output_z, kernel_name="exp_neg"):
    ...
    res = vrec_compute(data_x, output_z, kernel_name)
