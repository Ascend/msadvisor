...
class TestMultiCores(unittest.TestCase):
    def setUp(self):
        dir_name = os.path.dirname(os.path.realpath(__file__))
        self.data_path = dir_name + '/test_ops_file/5_matmul_tik'
        self.parameter = {'local': 'en'}

    @classmethod
    def setUpClass(cls):
        print('CASE5'.center(100, '='))
    ...
    def test_evaluate(self):
        ...
        self.assertTrue(5 in advice_no_list_flat)
