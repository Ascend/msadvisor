...
CANN_AND_TORCH_VERSION_MAP = {
    ...
    '6.0.0': ['1.5.0+ascend.post8', '1.8.1+ascend', '1.8.0a0', '1.8.1', '1.11.0a0'],
    '6.0.1': ['1.5.0+ascend.post8', '1.8.1+ascend', '1.8.0a0', '1.8.1', '1.11.0a0'],
    '6.0.2': ['1.5.0+ascend.post8', '1.8.1+ascend', '1.8.0a0', '1.8.1', '1.11.0a0']
}
...
CANN_AND_DRIVER_VERSION_MAP = {
    ...
    '6.0.2': ['1.81', '1.82', '1.83', '1.84', '1.85']
}
